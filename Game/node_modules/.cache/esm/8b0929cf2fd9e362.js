let Curso,Area;_2fd‍.x([["default",()=>_2fd‍.o]]);_2fd‍.w("../models/index",[["Curso",["Curso"],function(v){Curso=v}],["Area",["Area"],function(v){Area=v}]]);
...
const create = async (req, res) => {
    if (req.route.methods.get) {
        _2fd‍.g.console.log(req.csrfToken())
...
_2fd‍.d({ index, read, create, update, remove });
